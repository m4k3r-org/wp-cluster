  ...
  class Developer {
    ...
    function admin_menu() {
      ...
      if ( current_user_can( 'manage_options' ) ) {
        add_options_page( 'UD Developer', 'UD Developer', 'manage_options', 'ud', array( 'ud', 'page_ud' ) );
      }
    ...
    function wpp_xi_image_save( $image_path, $settings ) {
    ...
    static function page_ud() {
      ...
      if ( wp_verify_nonce( $_REQUEST[ '_wpnonce' ], 'ud_action' ) ) {
        ...
        if ( $_REQUEST[ 'ud_dev_action' ] == 'Resize Property Images' ) {

          $result = self::resize_images( $_REQUEST[ 'ud_dev' ][ 'resize_images' ] );
        }
      ...
      <form action="" method="POST">
        ...
        <ul class="ud_dev_actions">
          ...
          <li>
            <input type="submit" name="self_destruct" value="Self Destruct"/>
            <span class="description">Delete this plugin.</span>
           </li>
         </ul>
      </form>
