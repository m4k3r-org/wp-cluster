...
namespace Flawless {
  ...
  class Shortcodes extends Module {
    ...
    function init() {
      ...
      if ( !in_array( 'list-attachments', array_keys( $shortcode_tags ) ) ) {
        add_shortcode( 'list_attachments', array( 'Shortcodes', 'list_attachments' ) );
      }
  ...
  add_action( 'flawless_content_type_added', array( 'Shortcodes', 'flawless_content_type_added' ) );
  add_action( 'flawless::init_lower', array( 'Shortcodes', 'init' ) );

  add_shortcode( 'code', array( 'Shortcodes', 'code' ) );
  add_shortcode( 'breadcrumbs', array( 'Shortcodes', 'breadcrumbs' ) );
  add_shortcode( 'current_year', array( 'Shortcodes', 'current_year' ) );
  add_shortcode( 'site_description', array( 'Shortcodes', 'site_description' ) );
  add_shortcode( 'post_link', array( 'Shortcodes', 'post_link' ) );
  add_shortcode( 'button', array( 'Shortcodes', 'button' ) );
  add_shortcode( 'get_permalink', array( 'Shortcodes', 'get_permalink' ) );
  add_shortcode( 'image_url', array( 'Shortcodes', 'image_url' ) );
  add_shortcode( 'pdf', array( 'Shortcodes', 'google_docs_pdf' ) );
  add_shortcode( 'placeholder', array( 'Shortcodes', 'placeholder' ) );
