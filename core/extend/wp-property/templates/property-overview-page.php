...
<?php get_template_part( 'templates/header', 'property-overview' ); ?>

<?php get_template_part( 'templates/attention', 'property-overview' ); ?>
...
<?php get_template_part( 'templates/footer', 'property-overview' ); ?>