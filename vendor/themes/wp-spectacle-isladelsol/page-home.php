...
?>
  ...
  <div class="diamond-box diamond-box-left">
    <div class="inner">
      <strong>
        ...
        <br><?php echo date( 'F jS', strtotime( $artist_lineup[0][ 'data' ][ 'date' ] ) ); ?>
      </strong>

      <?php echo $artist_lineup[0][ 'data' ][ 'location' ]; ?>
  ...
  <div class="diamond-box diamond-box-right">
    <div class="inner">
      <strong>
        <?php echo date( 'l', strtotime( $artist_lineup[1][ 'data' ][ 'date' ] ) ); ?>
        <br><?php echo date( 'F jS', strtotime( $artist_lineup[1][ 'data' ][ 'date' ] ) ); ?>
      </strong>
      <?php echo $artist_lineup[1][ 'data' ][ 'location' ]; ?>
