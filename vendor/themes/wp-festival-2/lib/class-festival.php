...
/*        array(
      ...
      // Developer Mode for JS
      // @todo Fix - For now always making true, even if script debug is off due to production issues
      if( true || ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) ){
        add_filter( 'home_url', function( $url ) {
          return str_replace( '/wp-festival-2/static/scripts/app', '/wp-festival-2/static/scripts/src/app', $url );
        } );
    ...
    /**
     * This function basically prints out our meta information in the header
     */
    public function wp_head(){ ?>
      <meta name="festival:url" content="<?php echo addcslashes( get_template_directory_uri(), '"' ); ?>" /> <?php
    }
