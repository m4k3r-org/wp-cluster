...
<p>
  <img id="feature-item-widget-selected-image" src="<?php echo $data['images']['meta']['sel_image']; ?>" alt="Selected Image">
</p>
<?php endif; ?>
<p>
  ...
  <select class="widefat feature-item-widget-image" name="<?php echo $this->get_field_name( 'image' ); ?>" id="<?php echo $this->get_field_id( 'image' ); ?>">
