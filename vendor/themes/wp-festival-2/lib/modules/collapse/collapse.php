 ...
 *
 */
if( !class_exists( 'UsabilityDynamics_Festival2_CollapseModule' ) ) {

  /**
   *
   */
  class UsabilityDynamics_Festival2_CollapseModule extends \UsabilityDynamics\Theme\Module {
    ...
    public function __construct(){
      ...
      parent::__construct( 'cfct-module-collapse', __( 'Collapse', wp_festival2( 'domain' ) ), $opts );
    }
