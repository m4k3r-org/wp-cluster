...
if( !class_exists( 'UsabilityDynamics_Festival2_FestivalLoopModule' ) ) {

  class UsabilityDynamics_Festival2_FestivalLoopModule extends cfct_build_module {
...
# Admin Form
    ...
    public function admin_form( $data ) {
      ...
      $templates = array(
        'default' => __( 'Default', wp_festival2( 'domain' ) ),
        'featured' => __( 'Featured', wp_festival2( 'domain' ) ),
        'slider' => __( 'Slider', wp_festival2( 'domain' ) ),
      );
