<div id="<?php echo $this->id_base; ?>-admin-form-wrapper">
  ...
  <fieldset class="cfct-form-section">
    <!-- title -->
    <legend><?php _e( 'Title', wp_festival2( 'domain' ) ); ?></legend>
    <div class="cfct-inline-els">
      <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', wp_festival2( 'domain' ) ); ?></label>
      <input
        type="text"
    ...
    <div class="cfct-inline-els">
      <label for="<?php echo $this->get_field_id( 'content' ); ?>"><?php _e( 'Tagline:', wp_festival2( 'domain' ) ); ?></label>
      <input
        type="text"
  ...
  <fieldset class="cfct-form-section" id="<?php echo $this->gfi( 'post_type_checks' ); ?>">
    <legend><?php _e( 'Post Type', wp_festival2( 'domain' ) ); ?></legend>
  ...
  <fieldset class="cfct-form-section">
    ...
    <div class="<?php echo $this->id_base; ?>-display-group-left">
      <div class="cfct-inline-els">
        <label for="<?php echo $this->get_field_id( 'template' ); ?>"><?php _e( 'Template:', wp_festival2( 'domain' ) ); ?></label>
