    ...
    <div class="<?php flawless_module_class( 'taxonomy-archive' ); ?>">
      ...
      <div id="section_event_details">
        ...
        <header class="entry-title-wrapper term-title-wrapper">
          ...
          <h1 class="entry-title"><?php echo $promoter->post('post_title'); ?></h1>
        </header>
      ...
      <div id="section_event">
        <h1><?php echo $promoter->post('post_title'); ?> <?php _e('Events'); ?></h1>
      ...
      <div id="section_hdp_photo_gallery">
        <h1><?php echo $promoter->post('post_title'); ?> <?php _e('Photos'); ?></h1>
      ...
      <div id="section_hdp_video">
        <h1><?php echo $promoter->post('post_title'); ?> <?php _e('Videos'); ?></h1>
