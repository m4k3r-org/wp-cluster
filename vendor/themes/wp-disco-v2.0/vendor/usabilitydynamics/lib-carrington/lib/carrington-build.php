...
function cfct_where_are_you( $file, $filter = null ) {
  ...
  $_explode = explode( DIRECTORY_SEPARATOR, WP_CONTENT_DIR );

  $wp_content_name = end( $_explode );

  $_more = explode( $wp_content_name, $path );

  $url = WP_CONTENT_URL . trailingslashit( end( $_more ) );
