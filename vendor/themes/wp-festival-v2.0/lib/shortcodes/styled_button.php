...
* Type: shortcode
* Group: Festival
* Class: UsabilityDynamics\Festival2\Shortcode_Styled_Button
* Version: 1.0
...
namespace UsabilityDynamics\Festival2 {
   ...
   */
  if( !class_exists( 'UsabilityDynamics\Festival2\Shortcode_Styled_Button' ) ) {
    ...
    class Shortcode_Styled_Button extends \UsabilityDynamics\Shortcode\Shortcode {
      ...
      public function __construct( $options = array() ) {
        ...
        $this->name = __( 'Styled Button', wp_festival2( 'domain' ) );

        $this->description = __( 'Draws a button styled by setting different parameters.', wp_festival2( 'domain' ) );
      ...
      public function call( $atts = "" ) {
        ...
        $atts = shortcode_atts( array(
          ...
          'anchor' => __( 'Button', wp_festival2( 'domain' ) ), //** Button text */
          'url' => '#', //** Button url */
          'style' => '', //** Custom styles */
