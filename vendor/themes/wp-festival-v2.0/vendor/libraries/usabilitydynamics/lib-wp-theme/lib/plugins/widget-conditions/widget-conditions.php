...
namespace UsabilityDynamics\Theme {
  class WidgetConditions {
    ...
    public static function widget_admin_setup() {
      wp_enqueue_style( 'widget-conditions', plugins_url( '/styles/widget-conditions.css', __FILE__ ) );
      wp_enqueue_script( 'widget-conditions', plugins_url( '/scripts/widget-conditions.js', __FILE__ ), array( 'jquery', 'jquery-ui-core' ), 20130129, true );
    }
  ...
  add_action( 'init', array( 'UsabilityDynamics\Theme\WidgetConditions', 'init' ) );
}