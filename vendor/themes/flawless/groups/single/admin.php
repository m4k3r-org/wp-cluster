<form action="<?php bp_group_admin_form_action() ?>" name="group-settings-form" id="group-settings-form" class="form-horizontal validate-form" method="post" enctype="multipart/form-data" role="main">
...
<?php do_action( 'bp_before_group_details_admin' ); ?>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" name="group-name" id="group-name" aria-required="true" value="<?php bp_group_name(); ?>" class="input-xlarge focused" />
      <p class="help-inline"><?php _e( 'A Group Name is required.', 'flawless' ); ?></p>
    </div>
  </div>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <textarea name="group-desc" id="group-desc" aria-required="true" class="span7 input-xxlarge"><?php bp_new_group_description(); ?></textarea>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <label class="checkbox">
        <input type="checkbox" name="group-notify-members" value="1" />
        <?php _e( 'Notify group members of changes via email', 'buddypress' ); ?>
      </label>
    </div>
  </div>
    ...
    <input class="btn btn-primary"  type="submit" value="<?php _e( 'Save Changes', 'buddypress' ) ?>" id="save" name="save" /></p>
  </div>
...
<?php if ( bp_is_group_admin_screen( 'group-avatar' ) ) : ?>
	...
	<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
      ...
      <div class="form-actions">
        ...
        <?php bp_button( array( 'id' => 'delete_group_avatar', 'component' => 'groups', 'wrapper_id' => 'delete-group-avatar-button', 'link_class' => 'edit btn btn-danger', 'link_href' => bp_get_group_avatar_delete_link(), 'link_title' => __( 'Delete Avatar', 'buddypress' ), 'link_text' => __( 'Delete Avatar', 'buddypress' ) ) ); ?>
