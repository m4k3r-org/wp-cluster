 ...
 *
 */
namespace UsabilityDynamics\Eventbrite {

  if( !class_exists( 'UsabilityDynamics\Eventbrite\Client' ) ) {
    ...
    class Client {
        ...
        public static function OAuthLogin($auth_tokens, $get_token='getAccessToken', $save_token='saveAccessToken', $delete_token='deleteAccessToken'){
            ...
            if( isset($auth_tokens['access_token']) ){
                try{
                    ...
                    $eb = new \UsabilityDynamics\EB\Client(array('access_token' => $auth_tokens['access_token']));
            ...
            if( $user == false ){
                ...
                if( isset($auth_tokens['access_code']) ){
                    ...
                    try{
                        $eb = new \UsabilityDynamics\EB\Client($auth_tokens );
        ...
        public static function loginWidget( $options, $get_token='getAccessToken', $save_token='saveAccessToken', $delete_token='deleteAccessToken', $render_login_box='widgetHTML' ){
            ...
            $response = self::OAuthLogin($options, $get_token, $save_token, $delete_token);
            ...
            if( is_array($response)){
                ...
                $login_params['oauth_link'] = self::oauthNextStep($options['app_key']);
