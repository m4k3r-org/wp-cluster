 ...
 */
/*
Plugin Name: Brightcove Video Clouds
Plugin URL: 
...
wp_register_script( 'brightcove_script', '/wp-content/plugins/brightcove-video-cloud-1.1/js/BrightcoveExperiences.js', array(), null, false);
...
function add_validation_scripts()
{
  ...
  wp_register_script( 'jquery-validate', '/wp-content/plugins/brightcove-video-cloud-1.1/jQueryValidation/jquery.validate.min.js');
  wp_enqueue_script( 'jquery-validate' );

  wp_deregister_script('jquery-validat-addional');
  wp_register_script( 'jquery-validate-addional', '/wp-content/plugins/brightcove-video-cloud-1.1/jQueryValidation/additional-methods.min.js');
...
wp_register_script( 'dynamic_brightcove_script', '/wp-content/plugins/brightcove-video-cloud-1.1/dynamic_brightcove.js');
...
function add_mapi_script() {
	...
	wp_register_script( 'mapi_script', '/wp-content/plugins/brightcove-video-cloud-1.1/bc-mapi.js');
