...
namespace UsabilityDynamics\Cluster {
  ...
  if( !class_exists( 'UsabilityDynamics\Cluster\Theme' ) ) {
    ...
    class Theme {
       ...
       * Initialize Theme
       *
       * @todo Refactor this, not really sure what it's doing right now
       * @for Theme
       */
      public function __construct() {
        ...
        /**
         * Looks like this functionality was moved to wp-veneer, instead of wp-cluster, this file may no longer
         * be needed
         */
        return;
        ...
        $this->domain = isset( $wp_cluster ) && $wp_cluster->domain ? $wp_cluster->domain : '';
        $this->site_name = isset( $wp_cluster ) && $wp_cluster->site_name ? $wp_cluster->site_name : '';
