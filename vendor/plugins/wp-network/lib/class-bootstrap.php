  ...
  if( !class_exists( 'UsabilityDynamics\Network\Bootstrap' ) ) {
    ...
    class Bootstrap {
      ...
      function admin_head() {
        ...
        jQuery( document.createElement( 'input' ) ).attr( 'type', 'hidden' ).attr( 'name', 'jsEnabled' ).attr( 'value', 'true' ).appendTo( '#site-assign-form' );
          ...
          if( !empty( $sites ) ) {
            if( RESCUE_ORPHANED_BLOGS && ENABLE_NETWORK_ZERO ) {
              ...
              <div id="message" class="error">
								...
								<p><label for="override"><?php esc_html_e( 'If you still want to delete this network, check the following box' ); ?>
            ...
            if( RESCUE_ORPHANED_BLOGS && ENABLE_NETWORK_ZERO ) {
              ...
              <div id="message" class="error">
                  ...
                  <?php } ?>
								...
								<p><label for="override"><?php esc_html_e( 'If you still want to delete these networks, check the following box' ); ?>
                    :</label> <input type="checkbox" name="override" id="override"/></p>
							</div>
            <?php } else { ?>
              <div id="message" class="error">
