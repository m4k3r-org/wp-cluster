...
var hddp = jQuery.extend( true, {
  ...
  'elastic_filter_init': function() {
    ...
    if( typeof window.ef_app === 'undefined' ) { return new Error( 'Elastic Filter not found.' ); }
...
jQuery( document ).bind( 'hddp::initialize', function() {
  ...
  if( typeof hdp_current_event === 'object' && hdp_current_event.geo_located === 'true' && typeof google === 'object' && typeof google.maps === 'object' ) {
    ...
    jQuery( document ).ready( function() {
      ...
      hdp_current_event.marker
        = new google.maps.Marker( { map: hdp_current_event.map, position: hdp_current_event.map.getCenter() } );
...
jQuery( document ).ready( function() {
  ...
  if( jQuery( 'body' ).hasClass( 'home' ) ){
    ...
    jQuery( window ).on( 'resize', function(){ resizerTimer(); } );
