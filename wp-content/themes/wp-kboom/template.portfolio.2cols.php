            ...
            <div id="white-background">
                ...
                <div id="content" class="container clearfix" style="padding-bottom: 20px;">
                    ...
                    <ul class="filterable" id="<?php echo of_get_option('sc_portfoliofilters')=='javascript' ? 'filterable' : '' ?>">
                        ...
                        <li><a href="javascript:;" class="<?php echo $category->category_nicename;?> filter" data-filter="<?php echo $category->category_nicename;?>"><?php echo $category->name;?></a></li>
                        <?php }?>
                    ...
                    <div class="portfolio-container">
                        ...
                        <ul id="portfolio-items-one-half"  class="portfolio-items-one-half clearfix">
                                        ...
                                        <div class="link-holder">
                                            <div class="portfolio-item-holder">
                                                <div class="portfolio-item-hover-content">
                                                    ...
                                                    if (!$thumb == ''){ ?>
                                                        <a href="<?php echo $large[0] ?>" title="<?php the_title(); ?>" data-rel="prettyPhoto" class="zoom photo">View Image</a>
