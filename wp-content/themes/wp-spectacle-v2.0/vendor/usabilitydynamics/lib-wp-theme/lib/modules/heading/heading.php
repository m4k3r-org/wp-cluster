...
if( !class_exists( 'HeadingModule' ) ) {
   ...
   * @class HeadingModule
   */
  class HeadingModule extends cfct_build_module {

    protected $_deprecated_id = 'cfct_module_heading'; // deprecated property, not needed for new module development
