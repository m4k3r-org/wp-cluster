...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
  ...
  <form action="" method="post" id="avatar-upload-form" class=" standard-form clearfix" enctype="multipart/form-data">
    ...
    <?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
      ...
      <p id="avatar-upload">
        ...
        <input type="submit" class="btn btn-success" name="upload" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ) ?>" />
      ...
      <?php if ( bp_get_user_has_avatar() ) : ?>
        ...
        <p><a class="button edit btn" href="<?php bp_avatar_delete_link() ?>" title="<?php _e( 'Delete Avatar', 'buddypress' ) ?>"><i class="icon-trash"></i> <?php _e( 'Delete My Avatar', 'buddypress' ) ?></a></p>
      <?php endif; ?>
