...
if (!class_exists('ud_cfct_module_loop') && class_exists('cfct_build_module')) {
	class ud_cfct_module_loop extends cfct_build_module {
    ...
    protected function get_custom_loop($data, $args = array()) {
      ...
      while ( $query->have_posts()) {
        ...
        <div data-post-id="post-<?php the_ID(); ?>" <?php post_class('clearfix cb_custom_entry ' . ( $args['this_count'] % 2 ? 'odd' : 'even') ); ?> object_count="<?php echo $args['this_count'] % 2 ? 'odd' : 'even'; ?>">
          ...
          <?php echo Flawless_F::get_template_part( 'entry-meta-header', get_post_format() ); ?>

          <?php echo Flawless_F::get_template_part( 'entry-content',  get_post_format() ); ?>

          <?php echo Flawless_F::get_template_part( 'entry-meta-footer', get_post_format() ); ?>
...
// Content Move Helpers
	...
	cfct_build_register_module('ud_cfct_module_loop');
}
