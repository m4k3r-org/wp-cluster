<p>
  <label for="<?php echo $this->get_field_id( 'text1' ); ?>">Overlay Text1 (Before Play Icon)</label>
  <br><br>
  <input class="widefat" type="text" name="<?php echo $this->get_field_name( 'text1' ); ?>" id="<?php echo $this->get_field_id( 'text1' ); ?>" value="<?php echo $data[ 'text1' ]; ?>" />
</p>

<p>
  <label for="<?php echo $this->get_field_id( 'text2' ); ?>">Overlay Text2 (After Play Icon)</label>
  <br><br>
  <input class="widefat" type="text" name="<?php echo $this->get_field_name( 'text2' ); ?>" id="<?php echo $this->get_field_id( 'text2' ); ?>" value="<?php echo $data[ 'text2' ]; ?>" />
</p>
