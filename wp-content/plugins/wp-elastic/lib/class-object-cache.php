...
class WP_Object_Cache {
   ...
   */
  function add( $key, $data, $group = null, $expire = 0 ) {
   ...
   */
  function decr( $key, $offset = 1, $group = null ) {
   ...
   */
  function delete( $key, $group = null, $deprecated = false ) {
    if( empty( $group ) )
      $group = $this->default_group;
   ...
   *    contents on success
   */
  function get( $key, $group = null, $force = false, &$found = null ) {
    if( empty( $group ) )
      $group = null;
   ...
   * @return false|int False on failure, the item's new value on success.
   */
  function incr( $key, $offset = 1, $group = null ) {
    if( empty( $group ) )
      $group = null;
   ...
   */
  function replace( $key, $data, $group = null, $expire = 0 ) {
    if( empty( $group ) )
      $group = null;
   ...
   * @return bool Always returns true
   */
  function set( $key, $data, $group = null, $expire = 0 ) {
...
function wp_cache_add( $key, $data, $group = '', $expire = 0 ) {
  ...
  if( method_exists( $wp_object_cache, 'add' ) ) {
...
function wp_cache_delete( $key, $group = '' ) {
  ...
  if( method_exists( $wp_object_cache, 'delete' ) ) {
