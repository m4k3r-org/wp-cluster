...
<div id="post-<?php the_ID(); ?>" class="<?php flawless_module_class( 'loop-listing cfct-module' ); ?>">
  <div class="post_listing_inner">
    ...
    <?php flawless_page_title( array( 'link' => true, 'title' => get_the_title(  get_the_ID() ), 'before' => '<h2 class="entry-title">', 'after' => '</h2>' ) ); ?>

    <?php get_template_part( 'templates/entry-meta-header', get_post_format() ); ?>

    <?php get_template_part( 'templates/entry-content',  get_post_format() ); ?>

    <?php get_template_part( 'templates/entry-meta-footer', get_post_format() ); ?>
