...
<div class="wrap">
  ...
  <div class="error settings-error" id="setting-error-settings_updated">
    <p><strong><?php echo sprintf(__('Currently your ElasticSearch configuration is empty. Visit <a href="%s">Server</a> section to configure.'), admin_url('admin.php?page=wp-disco-manage-search-server')); ?></strong></p>
  </div>
  <?php endif; ?>
