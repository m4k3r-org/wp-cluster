...
<div class="flawless_header_expandable_sections">
  <?php get_template_part( 'templates/header-element', 'contact-us' ); ?>
  <?php get_template_part( 'templates/header-element', 'login' ); ?>
</div>
...
<div class="super_wrapper">
  ...
  <div class="general_header_wrapper">
    <div class="header container clearfix flawless_dynamic_area" container_type="header">
      ...
      <?php if ( $flawless_header_actions_menu = wp_nav_menu( apply_filters( 'header-actions-menu', array( 'theme_location' => 'header-actions-menu', 'container_class' => 'header-actions-menu', 'menu_class' => 'header-actions-menu flawless-menu no-print', 'fallback_cb' => false, 'echo' => false ) ) ) ): ?>
        <?php echo $flawless_header_actions_menu; ?>
      <?php endif; ?>
      ...
      <?php if ( current_theme_supports( 'header-logo' ) && $flawless[ 'flawless_logo' ][ 'url' ] ): ?>
        <div <?php flawless_element( 'logo_area_wrapper cfct-block inner_container' ); ?>>
          <a href="<?php echo home_url(); ?>" class="header_logo_image" title="<?php bloginfo( 'name' ); ?>">
            <img class="header_logo_image" src="<?php echo $flawless[ 'flawless_logo' ][ 'url' ]; ?>"
      ...
      <?php if ( current_theme_supports( 'header-dropdowns' ) ): ?>
        <?php get_template_part( 'templates/header-element', 'dropdown-links' ); ?>
      <?php endif; ?>
