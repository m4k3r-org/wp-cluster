  ...
  if( !class_exists( '\UsabilityDynamics\AMD\Scaffold' ) ) {
    ...
    abstract class Scaffold {
      ...
      public function admin_init() {
        ...
        add_settings_section( 'wp-amd-rewrites', __( 'Asset Rewrites', get_wp_amd( 'text_domain' ) ), function() {
          echo '<p>' . __( 'Assets generated by wp-amd may have custom rewrite paths.', get_wp_amd( 'text_domain' ) ) . '</p>';
        }, 'permalink' );

        add_settings_field( 'wp-amd.rewrites.script', __( 'Script URL', get_wp_amd( 'text_domain' ) ), function() {
        ...
        add_settings_field( 'wp-amd.rewrites.style', __( 'Style URL', get_wp_amd( 'text_domain' ) ), function() {
          echo '<code>' . untrailingslashit( get_option( 'home' ) ) . "</code>";
