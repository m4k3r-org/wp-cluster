  ...
  if( !class_exists( 'UsabilityDynamics\Theme\Disco\Start' ) ) {
    ...
    class Start extends \UsabilityDynamics\Flawless\Bootstrap {
      ...
      public function init() {
        ...
        add_action( 'flawless::extended_term_form_fields', array( get_class(), 'extended_term_form_fields' ), 10, 2 );
        ...
        add_filter( 'img_caption_shortcode', array( get_class(), 'img_caption_shortcode' ), 10, 3 );
      ...
      static public function admin() {
        ...
        add_filter( 'manage_hdp_venue_custom_column', array( get_class(), 'event_venue_columns_data' ), 10, 3 );
        ...
        add_filter( 'manage_hdp_event_posts_custom_column', array( get_class(), 'manage_hdp_event_posts_custom_column' ), 10, 2
        );
