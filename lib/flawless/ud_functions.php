 ...
 *
 * = 1.1.1 =
 * - Renamed UD_API_Transdomain to UD_Transdomain
 * - Renamed UD_API_Profiling to UD_Profiling
 * - Added __construct() for adding constants and otherwise initializing class, even when static.
 *
 */
if( !class_exists( 'UD_Functions' ) ) {
  ...
  class UD_Functions extends UD_Saas {
     ...
     *
     * i.e. It should be used when $pwdb->prepare can not be used.
     * For example:
    ...
    static function array_merge_recursive_distinct() {
      _deprecated_function( __FUNCTION__, '3.5', 'UD_Functions::extend' );

      return UD_Functions::extend( func_get_args() );
    }
    ...
    static function update_qa_table_item( $post_id = false, $args ) {
      _deprecated_function( __FUNCTION__, '3.4', 'UD_Cloud::index' );
    }
