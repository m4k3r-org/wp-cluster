...
class flawless_theme_ui {
   ...
   *
   * @todo Once \UsabilityDynamics\Flawless\Utility::parse_readme() is updated to return data via associative array, this can be improved - potanin@UD
   * @author potanin@UD
   */
  function show_update_screen( $splash_type ) {
    $change_log = \UsabilityDynamics\Flawless\Utility::parse_readme(); ?>
  ...
  function options_ui_general( $flawless ) {
    ...
    $page_selection_404 = \UsabilityDynamics\Flawless\Utility::wp_dropdown_objects( array(
    ...
    $page_selection_not_found = \UsabilityDynamics\Flawless\Utility::wp_dropdown_objects( array(
    ...
    <ul class="flawless_logo_upload">
      ...
      <?php if( !empty( $flawless[ 'flawless_logo' ][ 'url' ] ) ) { ?>
        ...
        <input type="hidden" name="flawless_settings[flawless_logo][height]" value="<?php echo $flawless[ 'flawless_logo' ][ 'height' ]; ?>"/>
          ...
          <?php if( \UsabilityDynamics\Flawless\Utility::can_get_image( $flawless[ 'flawless_logo' ][ 'url' ] ) ) {
            ...
            <ul class="flawless_options_wrapper flawless_advanced_content_type_options">
              ...
              <?php if( $data[ 'flawless_post_type' ] == 'true' ) { ?>
                ...
                <label><?php _e( 'Root Page:', 'flawless' ) ?>
                  <?php \UsabilityDynamics\Flawless\Utility::wp_dropdown_objects( array(
  ...
  function options_ui_advanced( $flawless ) {
    ...
    <table class="form-table">
      ...
      <tr valign="top" class="flawless_javaScript_enhancements">
        ...
        <td>
          <ul class="wp-tab-panel">
            <li><label><input type="checkbox" <?php checked( 'true', $flawless[ 'enable_lazyload' ] ); ?>  name="flawless_settings[enable_lazyload]" value="true"/> <?php _e( 'Enable LazyLoad.', 'flawless' ); ?>
                <span class="description"><?php _e( 'Add .lazy class to images to use.', 'flawless' ); ?></label></li>
            ...
            <li><label><input type="checkbox" <?php checked( 'true', $flawless[ 'disable_fancybox' ] ); ?>  name="flawless_settings[disable_fancybox]" value="true"/> <?php _e( 'Disable FancyBox.', 'flawless' ); ?>
                <span class="description"><?php _e( 'Enabled by default and applied to all images.', 'flawless' ); ?></span></label></li>
          </ul>
        </td>
      </tr>
      ...
      <tr valign="top" class="flawless_backup_and_restoration">
        ...
        <td>
          <ul class="flawless" flawless="action_list">
            ...
            <li>
              <?php _e( 'Restore from file', 'flawless' ); ?>
              : <input name="flawless_settings[settings_from_backup]" type="file"/>
  ...
  function skin_selection( $args = false ) {
    ...
    $color_schemes = \UsabilityDynamics\Flawless\Utility::get_color_schemes();
