		...
		jQuery.ajax({
			...
			success: function(a){
                ...
                img += '</div>';
							...
							icon = '<a class="network-label" href="javascript:void(0);"><img src="'+path+o.icon+'" alt="" class="icon" /></a>';
                  ...
                  break;
							...
							var out = '<li rel="'+ob+'" url="'+q+'" data-net="'+type+'" class="dcsns-li dcsns-'+type+' dcsns-feed-'+fn+'">'+w+'<div class="inner">'+zz+'<span class="clear"></span></div>'+zintro+icon+'</li>', str = opt.remove;
...
function socialStreamInit(object) {
