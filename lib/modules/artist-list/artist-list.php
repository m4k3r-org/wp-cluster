...
if( !class_exists( 'cfct_module_carousel' ) && class_exists( 'cfct_build_module' ) ) {
  ...
  class ArtistList extends cfct_build_module {
    ...
    public function __construct() {
      ...
      wp_register_script( 'jquery-cycle', $this->get_url() . 'scripts/jquery.cycle.js', array( 'jquery' ), '1.0' );
    ...
    public function admin_css() {
      return preg_replace( '/^(\t){4}/m', '', '
				...
				.carousel-list li:hover {
					background: #fff url(' . $this->get_url() . 'images/carousel-drag.gif) 100% 50% no-repeat;
					cursor: move;
				}
