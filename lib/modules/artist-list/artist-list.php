 ...
 */
if( !class_exists( 'UsabilityDynamics_Festival2_ArtistListModule' ) ){

  class UsabilityDynamics_Festival2_ArtistListModule extends \UsabilityDynamics\Theme\Module {
    ...
    public function display( $data ){ 
      ...
      /** Get our template */
      ob_start();
      get_template_part( 'templates/aside/grid-artist', ( !empty( $data[ 'layout_type' ] ) ? $data[ 'layout_type' ] : 'rows' ) );
