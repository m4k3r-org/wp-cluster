...
<p>
  ...
  <label for="<?php echo $this->get_field_id( 'post_category' ); ?>"><?php _e( 'Show Post Category', 'recent-post-flexslider-locale' ) ?></label>
</p>
...
<p>
  ...
  <label for="<?php echo $this->get_field_id( 'post_date' ); ?>"><?php _e( 'Show Post Date', 'recent-post-flexslider-locale' ) ?></label>
</p>
