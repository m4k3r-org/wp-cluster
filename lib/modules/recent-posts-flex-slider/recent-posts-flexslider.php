...
class Recent_Posts_FlexSlider extends WP_Widget
{
  ...
  public function __construct(){
    ...
    parent::__construct( 'recent-posts-flexslider', __( 'Recent Posts FlexSlider', 'recent-posts-flexslider-locale' ), array(
  ...
  public function register_recent_posts_flexslider_styles(){
    ...
    wp_register_style( 'recent-posts-flexslider-widget-styles', str_ireplace( $_SERVER[ 'DOCUMENT_ROOT' ], '', __DIR__ ) . '/css/slider.css' );
  ...
  public function register_recent_posts_flexslider_scripts(){
    ...
    wp_register_script( 'recent-posts-flexslider-script', str_ireplace( $_SERVER[ 'DOCUMENT_ROOT' ], '', __DIR__ ) . '/js/jquery.flexslider-min.js', array( 'jquery' ), '2.0', false );
