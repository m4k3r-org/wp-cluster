<div class="video-container video-module-container" id="video-module-container">
  ...
  <div class="background-content" data-background-video-url="<?php echo $background_video_url; ?>">
    ...
    <div class="background-overlay">
      <a href="http://www.youtube.com/watch?v=<?php echo $code; ?>" class="watch-video">
        <?php if ($text1=='') $text1 = 'Watch'; echo $text1 ?>
        <span><i class="icon-video"></i></span> <?php if ($text2=='') $text2 = 'Video'; echo $text2 ?></a>
    </div>
  </div>
