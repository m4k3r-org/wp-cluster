  ...
  <div class="cfct-block sidebar-left span4 first visible-desktop">
    ...
    <ul class="dd_side_panel_nav">
      ...
      <?php foreach( (array) $found_content as $post_type => $data ) { ?>
        ...
        <i class="icon-<?php echo $post_type; ?> icon-dd"></i> <?php echo get_post_type_object( $post_type )->labels->name; ?>
            <span class="comment_count"><?php echo $data[ 'numberposts' ]; ?></span></a>
      </li>
      <?php } ?>
