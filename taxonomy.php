...
<?php get_template_part( 'templates/attention', 'taxonomy' ); ?>
  ...
  <div class="<?php flawless_wrapper_class(); ?>">
    ...
    <div class="<?php flawless_block_class( 'main cfct-block' ); ?>">
      <div class="<?php flawless_module_class( 'taxonomy-archive' ); ?>">
        ...
        <div
          class="loop loop-blog post-listing clearfix"><?php foreach ( (array)$found_content as $post_type => $this_query ) {
            query_posts( $this_query ); ?>
