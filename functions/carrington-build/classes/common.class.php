		...
		switch (true) {
			...
			case strpos($module, 'wp-content') !== false:
				# this is a pretty good guess... let's go with it.				
       				...
       				/* Modified by potaniN@UD. 'siteurl' does not take into account WP being in a subfolder, and is not best choice to use here */
				$url = trailingslashit(get_bloginfo('wpurl').substr(dirname($module), strpos($module, 'wp-content') - 1, strlen($module) -1));
