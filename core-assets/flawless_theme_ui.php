...
class flawless_theme_ui {
  ...
  <div class="wrap flawless-update about-wrap flawless_settings_page">
    ...
    <div class="about-text"><?php printf( __('Thank you for updating to the latest version! Please take a look at some of the updates, <a href="%1s">go to dashboard</a> or <a href="%2s">view settings page</a>.' , 'flawless' ), admin_url(), '#flawless_action#toggle=.flawless_settings_page' ); ?></div>
  ...
  function options_ui_advanced( $flawless ) { ?>
    ...
    <table class="form-table">
      ...
      <th><?php _e( 'Advanced Settings' , 'flawless' ); ?></th>
        <td>
          <ul class="wp-tab-panel">
            ...
            <li>
              <label>
                <input type="checkbox" <?php checked( $flawless[ 'console_log_options' ][ 'show_log' ], 'true' ); ?> name="flawless_settings[console_log_options][show_log]" value="true" />
                <?php _e( 'Display basic log entries in console log.', 'flawless' ); ?>
				<span class="description"><?php _e( 'Error and Info log entries are always displayed (when debug mode is enabled).', 'flawless' ); ?></span>
              </label>
            </li>

            <li>
              <label>
                <input type="checkbox" <?php checked( $flawless[ 'do_not_compile_plugin_css' ], 'true' ); ?> name="flawless_settings[do_not_compile_plugin_css]" value="true" />
      ...
      <tr valign="top" class="flawless_javaScript_enhancements">
        ...
        <td>
          <ul class="wp-tab-panel">
            <li><label><input type="checkbox" <?php checked( 'true', $flawless[ 'disable_masonry' ] ); ?>  name="flawless_settings[disable_masonry]" value="true" /> <?php _e( 'Disable Masonry.', 'flawless' ); ?> <span class="description"><?php _e( 'Removes masonry library, which is applied to Galleries, or on demand using .enable-masonry class.', 'flawless' ); ?></span></label></li>
            <li><label><input type="checkbox" <?php checked( 'true', $flawless[ 'disable_equalheights' ] ); ?>  name="flawless_settings[disable_equalheights]" value="true" /> <?php _e( 'Disable EqualHeights.', 'flawless' ); ?></label></li>
            <li><label><input type="checkbox" <?php checked( 'true', $flawless[ 'enable_lazyload' ] ); ?>  name="flawless_settings[enable_lazyload]" value="true" /> <?php _e( 'Enable LazyLoad.', 'flawless' ); ?> <span class="description"><?php _e( 'Add .lazy class to images to use.', 'flawless' ); ?></span></label></li>
  ...
  function skin_selection( $args = false ) {
    ...
    <li class="flawless_setup_option_block">
      ...
      <div class="skin_thumb_placeholder flawless_no_image">
        <img class="skin_thumb" src="<?php echo flawless_theme::load( 'no-skin-thumbanil.gif', 'image' ); ?>" title="<?php _e( 'No Thumbnail Found', 'flawless' ); ?>" />
      </div>
      <?php } ?>
    ...
    <?php } ?>
      <li class="flawless_setup_option_block">
        ...
        <div class="option_note"><strong><?php _e( 'No Skin', 'flawless' ); ?></strong><br /><?php _e( 'Twitter Bootstrap, Base and plugin-specific (when available) CSS only.', 'flawless' ); ?></div>
      </li>
    </ul>
